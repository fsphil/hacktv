...
static void print_usage(void)
{
	printf(
		...
		"  625ntsc       = NTSC colour,             25 fps,       625 lines, unmodulated (real)\n"
		"  ntsc443       = NTSC colour,             30/1.001 fps, 525 lines, unmodulated (real), 4.43 MHz colour carrier\n"
		"  ntsc-j        = NTSC colour,             30/1.001 fps, 525 lines, unmodulated (real), black at 0 IRE\n"
