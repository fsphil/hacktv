...
const vid_config_t vid_config_ntsc_j = {
	...
	.white_level    =  0.70,
	.black_level    =  0.00, /* The black level and blanking level of the NTSC-J signal are identical (at 0 IRE) */
	.blanking_level =  0.00,
	.sync_level     = -0.30,
...
const vid_config_t vid_config_625 = {
...
const vid_config_t vid_config_525 = {
