...
OBJS    := hacktv.o common.o fir.o vbidata.o teletext.o wss.o video.o mac.o eurocrypt.o videocrypt.o videocrypts.o syster.o acp.o nicam728.o test.o ffmpeg.o file.o hackrf.o
